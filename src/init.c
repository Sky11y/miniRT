...
void	init_camera(t_camera *cam, const t_image *img)
{
	...
	fprintf(infolog, "Camera center: [%f, %f, %f]\n", cam->center.x, cam->center.y, cam->center.z);
	fprintf(infolog, "Camera lookat: [%f, %f, %f]\n", cam->lookat.x, cam->lookat.y, cam->lookat.z);
	fprintf(infolog, "Camera direction: [%f, %f, %f]\n", cam->w.x, cam->w.y, cam->w.z);
}
