...
/*   Updated: 2025/06/30 16:29:12 by jpiensal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
float hit_sphere(const t_sphere s, const t_ray r)
{
	...
	//float a_unsquared = v_length(r.direction);
	//float oc_unsquared = v_length(oc);
	//float a = a_unsquared * a_unsquared;
	//float h = dot(r.direction, oc);
	//float c = oc_unsquared * oc_unsquared - s.radius * s.radius;
...
int main()
{
	...
	t_sphere sphere1 = { { -0.6, 0, -1 }, { 0, 0, 0, 255 }, 0.5 };
