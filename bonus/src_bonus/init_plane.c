...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/20 10:27:04 by akiiski           #+#    #+#             */
/*   Updated: 2025/08/20 10:27:05 by akiiski          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	init_values(char **split, t_plane *plane)
{
	...
	if (split[4])
	{
		if (init_material(split[4], &plane->mat))
			return (1);
	}
	else
		set_material(&plane->mat, 0.0f, 0.0f, 0.0f);
	return (0);
}
